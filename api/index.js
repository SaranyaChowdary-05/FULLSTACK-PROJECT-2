...
let events = [
    { id: 1, _id: 1, title: "AI & Machine Learning Workshop", category: "Computer Science", description: "Hands-on deep learning with TensorFlow and PyTorch.", price: 750, date: "2026-04-26", location: "CS Lab 4", imageUrl: "https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&q=80&w=800", capacity: 50, registrations: 50 },
    { id: 2, _id: 2, title: "Annual Robotics Challenge", category: "Engineering", description: "Build and battle bots in a live arena.", price: 900, date: "2026-04-28", location: "Main Auditorium", imageUrl: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=800", capacity: 100, registrations: 100 },
    { id: 3, _id: 3, title: "Creative Arts Exhibition", category: "Fine Arts", description: "Student art showcase and live painting.", price: 450, date: "2026-04-30", location: "Arts Gallery", imageUrl: "https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?auto=format&fit=crop&q=80&w=800", capacity: 150, registrations: 120 },
    { id: 4, _id: 4, title: "Quantum Physics Symposium", category: "Physics", description: "Expert talks on quantum mechanics and entanglement.", price: 600, date: "2026-05-15", location: "Main Auditorium", imageUrl: "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&q=80&w=800", capacity: 80, registrations: 30 },
    { id: 5, _id: 5, title: "Global Business Strategy", category: "Commerce", description: "Case study competition with industry leaders.", price: 850, date: "2026-05-18", location: "Main Auditorium", imageUrl: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=800", capacity: 50, registrations: 49 },
    { id: 6, _id: 6, title: "Bio-Tech Innovation Fair", category: "Biology", description: "Future of CRISPR and gene editing.", price: 950, date: "2026-05-20", location: "Bio-Tech Wing", imageUrl: "https://images.unsplash.com/photo-1576086213369-97a306d36557?auto=format&fit=crop&q=80&w=800", capacity: 120, registrations: 40 },
    { id: 7, _id: 7, title: "Literature & Poetry Slam", category: "English", description: "Spoken word night under the stars.", price: 300, date: "2026-05-22", location: "Arts Gallery", imageUrl: "https://images.unsplash.com/photo-1457369804613-52c61a468e7d?auto=format&fit=crop&q=80&w=800", capacity: 300, registrations: 150 },
    { id: 8, _id: 8, title: "Cyber Security: CTF", category: "IT Dept", description: "Capture the flag ethical hacking challenge.", price: 700, date: "2026-05-25", location: "CS Lab 1", imageUrl: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=800", capacity: 60, registrations: 60 },
    { id: 9, _id: 9, title: "Inter-Dept Football Cup", category: "Sports", description: "University-wide football tournament.", price: 250, date: "2026-06-05", location: "University Stadium", imageUrl: "https://images.unsplash.com/photo-1574629810360-7efbbe195018?auto=format&fit=crop&q=80&w=800", capacity: 1000, registrations: 450 },
    { id: 10, _id: 10, title: "Jazz & Blues Night", category: "Music", description: "Live music evening with guest performers.", price: 500, date: "2026-06-15", location: "Main Auditorium", imageUrl: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&q=80&w=800", capacity: 200, registrations: 180 },
    { id: 11, _id: 11, title: "Tree Plantation Drive", category: "Environment", description: "Greening the campus, one tree at a time.", price: 200, date: "2026-06-22", location: "University Stadium", imageUrl: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&q=80&w=800", capacity: 1000, registrations: 800 },
    { id: 12, _id: 12, title: "Esports Championship", category: "Gaming", description: "Valorant & FIFA inter-college tourney.", price: 600, date: "2026-07-05", location: "CS Lab 1", imageUrl: "https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&q=80&w=800", capacity: 64, registrations: 60 },
    { id: 13, _id: 13, title: "Eco-Friendly Runway", category: "Fashion", description: "Recycled materials fashion show.", price: 900, date: "2026-06-25", location: "Arts Gallery", imageUrl: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&q=80&w=800", capacity: 500, registrations: 120 },
    { id: 14, _id: 14, title: "Calculus Competition", category: "Math", description: "Olympiad-level mathematics challenge.", price: 400, date: "2026-06-20", location: "Main Auditorium", imageUrl: "https://images.unsplash.com/photo-1509228468518-180dd4864904?auto=format&fit=crop&q=80&w=800", capacity: 100, registrations: 98 }
];
